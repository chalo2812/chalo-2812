...
public class MenorEnteros extends ClaseNodo {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -161557372364536733L;

	public MenorEnteros(ClaseNodo nodo1, ClaseNodo nodo2){
		this.add(nodo1);
		this.add(nodo2);
	}
