...
import tp.procesadores.analizador.semantico.arbol.expresiones.ProductoEntero;
import tp.procesadores.analizador.semantico.arbol.tabla.simbolos.TablaDeSimbolos;
import tp.procesadores.analizador.sintactico.SintacticAnalyzer;
import tp.procesadores.analizador.sintactico.producciones.Produccion;
import tp.procesadores.analizador.sintactico.producciones.SimboloTerminal;

public class TERMP1 extends Produccion{
		...
		//TERM1'.ArbolH = CrearNodoMultiEntero ( TERM'.ArbolH, FACT.ArbolS) 
...
//			System.out.println("TERMP1");
			...
			if ( r )
			{
				...
				if ( r )
				{
					...
					ProductoEntero producto= new ProductoEntero(arbolH, arbolSp1.getArbol());  
