...
@XmlRootElement(name = "obtenerReferenciasResponse", namespace = "http://default_package/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "obtenerReferenciasResponse", namespace = "http://default_package/")

public class ObtenerReferenciasResponse {
