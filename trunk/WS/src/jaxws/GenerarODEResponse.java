...
@XmlRootElement(name = "generarODEResponse", namespace = "http://default_package/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "generarODEResponse", namespace = "http://default_package/")

public class GenerarODEResponse {
