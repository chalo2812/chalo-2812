...
@XmlRootElement(name = "obtenerODEResponse", namespace = "http://default_package/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "obtenerODEResponse", namespace = "http://default_package/")

public class ObtenerODEResponse {
